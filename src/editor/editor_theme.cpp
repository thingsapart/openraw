...
void SetRawrTheme() {
    ...
    colors[ImGuiCol_DockingPreview] = ImVec4(0.46f, 0.56f, 0.66f, 0.40f);        // Preview color for docking
    ...
    colors[ImGuiCol_TableRowBgAlt] = ImVec4(1.00f, 1.00f, 1.00f, 0.06f);         // Alternate row background
