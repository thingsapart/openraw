...
- [x] **Advanced Capture Sharpening:** Implement a high-quality unsharp mask on the luminance channel with controls for radius and a threshold/mask to protect flat areas from noise amplification.
