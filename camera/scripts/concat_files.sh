...
#
# Usage:
#   ./concat_files.sh                  - Processes files listed in scripts/files_default.txt.
#   ./concat_files.sh file1.c *.h      - Processes specified files, ignoring the default list.
#   ./concat_files.sh + file1.c *.h    - Adds specified files to the list from scripts/files_default.txt.
...
FINAL_MESSAGE=`cat ./scripts/final_msg.txt`
